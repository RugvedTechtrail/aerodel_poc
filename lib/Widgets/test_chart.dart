          ...
          children: [
            ...
            Obx(() => Column(
                  children: [
                    ...
                    // Flow-Volume Loop Chart with RepaintBoundary for capturing
                    RepaintBoundary(
                      key: controller.reportGenerator.chartKey,
                      child: SizedBox(
                        height: 320,
                        child: SfCartesianChart(
                          primaryXAxis: const NumericAxis(
                    ...
                    if (controller.isTestCompleted.value)
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ElevatedButton.icon(
                              onPressed: controller.openTextReport,
                            ...
                            ElevatedButton.icon(
                              onPressed: controller.openPdfReport,
                              icon: const Icon(Icons.picture_as_pdf),
                              label: const Text('PDF Chart Report'),
                              style: ElevatedButton.styleFrom(
                                backgroundColor: Colors.green,
                                foregroundColor: Colors.white,
                                padding: const EdgeInsets.symmetric(
